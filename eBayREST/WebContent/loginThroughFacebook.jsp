...
<script>
  ...
  function testAPI() {
    ...
    FB.api('/me', 'GET', {"fields":"id,name,email,picture"}, function(response) {
    	...
    	console.log("img url: "+ response.picture.data.url);
    	img = document.createElement('img');
    	img.src = response.picture.data.url;
    //	document.body.insertBefore(img, userName);
    	userName.innerHTML = response.name + '!';
    	document.getElementById('status').innerHTML += ' Your email id is ' + response.email;
